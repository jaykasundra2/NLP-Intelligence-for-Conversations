...
from api.model import Input, NEREntity, NERResponse
from api.class_ner import ClassNER
...
async def named_entity_recognition(item: Input):
    """
    This function is used to perform Named Entity Recognition for the input text
    ...
    * :return: Returns a list of dictionary. It will be of the structure:
    ...
    """
    ner_process = ClassNER(model=item.model.lower())
    text = item.text
